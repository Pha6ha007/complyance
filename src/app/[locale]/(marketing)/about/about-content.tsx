      ...
      <section className="relative border-t border-white/[0.06]">
        <div className="mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {[
              { emoji: '🏢', stat: t('problem.stat1Value'), label: t('problem.stat1Label'), text: t('problem.p1') },
              { emoji: '⚠️', stat: t('problem.stat2Value'), label: t('problem.stat2Label'), text: t('problem.p2') },
              { emoji: '📅', stat: t('problem.stat3Value'), label: t('problem.stat3Label'), text: t('problem.p3') },
